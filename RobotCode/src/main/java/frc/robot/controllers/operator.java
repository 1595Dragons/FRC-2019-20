...
public class operator {
    ...
    Button a = new JoystickButton(this.operator, 0), x = new JoystickButton(this.operator, 2),
            ...
            left_bumper = new JoystickButton(this.operator, 4), right_bumper = new JoystickButton(this.operator, 5);
